...
typedef struct rb_hash_literal_info {
    int is_empty;
} rb_hash_literal_info_t;

typedef struct rb_array_literal_info {
    int is_empty;
} rb_array_literal_info_t;

typedef struct rb_string_literal_info {
    rb_encoding *encoding;
    long length;
